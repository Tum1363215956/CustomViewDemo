 ...
 */
@SuppressLint("NewApi")
public class DragGridViewZaiGai extends GridView{
	/**
	...
	public DragGridViewZaiGai(Context context) {
		this(context, null);
	}
	
	public DragGridViewZaiGai(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public DragGridViewZaiGai(Context context, AttributeSet attrs, int defStyle) {
		...
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
				if (dPosition != AdapterView.INVALID_POSITION) {
					...
					mStartDragItemView = getChildAt(mDragPosition - getFirstVisiblePosition());//获取需要拖拽的View
					...
					mStartDragItemView.setVisibility(View.INVISIBLE);//设置为不可见
